...
const AdicionarTurmas = ({ navigation }) => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.inputsContainer}>
        <View style={styles.inputGroup}>
          ...
          >
            {cursos.map((curso) => (
              <Picker.Item label={curso.nome} value={curso.nome} key={curso.id} /> // Use curso.id as unique key
            ))}
          </Picker>
        </View>
        <View style={styles.inputGroup}>
      ...
      <TouchableOpacity style={styles.addTurmaButton} onPress={adicionarTurma}>
...
export default AdicionarTurmas;
