...
public class AvaliacaoCriterio implements Serializable {
    ...
    public static AvaliacaoCriterio of(AvaliacaoCriterioDTO aCCDTO) {
    	AvaliacaoCriterio aCC = new AvaliacaoCriterio();
